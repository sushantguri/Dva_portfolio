  ...
  return (
    <div className="app-container">
      <motion.nav 
        ...
        className="glass-panel nav-bar" style={{
        position: 'fixed',
        top: '1.5rem',
        left: '50%',
        ...
        <a href="#case-studies" style={{ fontWeight: 500, fontSize: '0.9rem', transition: 'color 0.2s', whiteSpace: 'nowrap' }} onMouseOver={e => e.target.style.color = 'var(--cyan)'} onMouseOut={e => e.target.style.color = 'var(--text-main)'}>Case Studies</a>
